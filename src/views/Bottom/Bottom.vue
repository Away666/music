  ...
  <div class="bottomControl">
    ...
    <div class="left">
      <div class="avatar">
        <img
          ...
          @click="goSongDetail"
        />
        <img src="~assets/images/test.jpg" alt="" v-else :draggable="false" />
      </div>
      <div class="musicInfo">
    ...
    >
      ...
      <el-table
        ...
        lazy
      >
        <el-table-column prop="name" width="175px"> </el-table-column>
        <el-table-column prop="ar[0].name" min-width="80px"> </el-table-column>
...
粤ICP备2021068014号<br>个人邮箱: 63012138@qq.com<br>本站为仿网易云音乐展示项目, 仅供学习使用, 侵权必删!</div>`,
  ...
  methods: {
    ...
    async getMusicDetail(id) {
      ...
      let result = await this.$http("/song/url", { id });
    ...
    getIsUserLikeCurrentMusic() {
      ...
      // );
      this.isUserLikeCurrentMusic = this.likeMuiscList.includes(
    ...
    async likeIt() {
      ...
      let res = await this.$http("/like", {
        id: this.$store.state.musicId,
        like: this.isUserLikeCurrentMusic,
      });
      console.log(res);
      if (res.data.code == 200) {
        this.$store.commit("changeCurrentLike", !this.isUserLikeCurrentMusic);
        console.log("喜欢操作成功");
      } else {
        console.log("喜欢操作失败");
      }
